    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('functionality', models.ForeignKey(help_text='The functionality this test case belongs to.', on_delete=django.db.models.deletion.CASCADE, related_name='test_cases', to='uat.functionality')),
            ],
        ),
        migrations.CreateModel(
            name='TestExecution',
